...
// function obtenerPersonal(listadoPersonal) {
//   const listadoPersonalFiltrado = listadoPersonal.filter((persona) => {
//     return persona.edad < 40 && persona.laborales.sector === "Contabilidad";
//   });

//   return listadoPersonalFiltrado.length;
// }

// console.log(obtenerPersonal(personalEmpresa));

function obtenerPersonal(listadoPersonal = []) {
  return listadoPersonal.filter(
    (persona) =>
      persona.edad < 40 && persona.laborales.sector === "Contabilidad"
  ).length;
}

const resultado = obtenerPersonal(personalEmpresa);
...
>>>>>>> 84dc51bb3edbe6d7b26371005761fc40e377f398
